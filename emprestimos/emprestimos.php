			...
			<form method="post" id="formCadastrarEmprestimo">
				<div class="form-row">
					...
					<div class="form-group col-md-3">
						...
						<select type="text" class="form-control" id="selectUsuario" name="usuario">
							<?php if($usuarios) : ?>
					...
					<div class="form-group col-md-2">
						<label for="inputData">Data do Empréstimo</label>
						<input type="text" placeholder="DD/MM/YYYY" onfocus="(this.type='date')" onblur="(this.type='text')" class="form-control" id="inputData" name="data">
					</div>
                ...
                <div class="form-row">
					...
					<div class="form-group col-md-2">
						<label for="inputDataDev">Data de Devolução</label>
						<input type="text" placeholder="DD/MM/YYYY" onfocus="(this.type='date')" onblur="(this.type='text')" class="form-control" id="inputDataDev" name="dataDev">
					</div>
					<div class="form-group col-md-2"></div>
                </div>
                <div class="form-row">
    ...
    $(document).ready(function(){ 
        ...
        $('#add').click(function(){
            ...
            if($('#add').text() == 'Adicionar') {
                ...
                output += '<td>'+devolucao+' <input type="hidden" name="hidden_devolucao[]" id="devolucao'+count+'" class="devolucao" value="'+devolucao+'" /></td>';
            ...
            // o laço de else abaixo só irá funcionar caso exista mais de um botão que possua a 'id' "add"
                ...
                output += '<td>'+devolucao+' <input type="hidden" name="hidden_devolucao[]" id="devolucao'+row_id+'" class="devolucao" value="'+devolucao+'" /></td>';
